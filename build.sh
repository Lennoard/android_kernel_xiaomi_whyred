...
TOOLCHAIN="/home/lennoard/aarch64-linux-gnu-8.x/bin/aarch64-linux-gnu-"

ARCHITECTURE="arm64"

KERNEL_NAME="dAnK Kernel"

KERNEL_VARIANT="dumpling"	# please leave as such

KERNEL_VERSION="v0.1"   # leave as such, if no specific version tag
...
KERNEL_IMAGE="$BUILD_DIR/arch/$ARCHITECTURE/boot/Image.gz-dtb"

ANYKERNEL_DIR="anykernel_dank"

RELEASE_DIR="release_dank"
...
export KBUILD_BUILD_USER=$KERNEL_NAME-lennoard
...
sed -i "s;-perf;-$KERNEL_VERSION;" $BUILD_DIR/.config;
